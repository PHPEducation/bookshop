...
@section('content')
        ...
        <div class="white-box">
            <div class="col-in row">
                <div class="col-md-6 col-sm-6 col-xs-6"> <i data-icon="E" class="linea-icon linea-basic"></i>
                    <h5 class="text-muted vb">{{trans('common.newClient')}}</h5> </div>
        ...
        <div class="white-box">
            <div class="col-in row">
                <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                    <h5 class="text-muted vb">{{trans('common.newProject')}}</h5> </div>
                <div class="col-md-6 col-sm-6 col-xs-6">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="white-box">
            <div class="col-in row">
                <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic" data-icon="&#xe00b;"></i>
                    <h5 class="text-muted vb">{{trans('common.newInvoice')}}</h5> </div>
                <div class="col-md-6 col-sm-6 col-xs-6">
...
<div class="row">
    <div class="col-md-12">
        <div class="white-box">
            <h3 class="box-title">{{trans('common.salesDiff')}}</h3>
            <ul class="list-inline text-right">
                <li>
                    <h5><i class="fa fa-circle m-r-5 siteA"></i>{{trans('common.siteA')}}</h5>
                </li>
                <li>
                    <h5><i class="fa fa-circle m-r-5 siteB"></i>{{trans('common.siteB')}}</h5>
                </li>
            </ul>
